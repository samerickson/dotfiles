...
function cfs
{ nvim "$HOME\.starship\starship.toml"
}
function cfa
{ nvim "$([Environment]::GetFolderPath("MyDocuments"))\PowerShell\Aliases.ps1"
}
function cfp
{ nvim "$([Environment]::GetFolderPath("MyDocuments"))\PowerShell\Private.ps1"
}
